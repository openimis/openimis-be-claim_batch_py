...
class ClaimBactchGQLTestCase(openIMISGraphQLTestCase):
    ...
    def setUpClass(cls):
        ...
        service = create_test_service(
            "B", custom_props={"name": "test_simple_batch"})
        ...
        create_test_claimitem(
            claim1, item.type, custom_props={
                "item_id": item.id, "qty_provided": 3, "price_origin": ProductItemOrService.ORIGIN_RELATIVE}
        )
        ...
        claim1.process_stamp = datetime.datetime(
            claim1.validity_from.year, claim1.validity_from.month, days_in_month - 1)
